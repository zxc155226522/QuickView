...
// Web / Modern formats
inline constexpr std::array<std::wstring_view, 15> WEB_MODERN_EXTENSIONS = {
    L".webp", L".avif", L".avifs", L".heic", L".heif", L".svg", L".svgz", L".jxl", L".apng", L".cdr", L".cmx", L".pdf", L".ai", L".plt", L".dxf"
};
...
static_assert(SUPPORTED_EXTENSIONS.size() == 73);
