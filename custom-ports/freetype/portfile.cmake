...
# [Clang-CL Fix] FreeType includes ftver.rc (version info) which triggers
# cmake_llvm_rc. vcpkg sets CMAKE_RC_FLAGS="/c65001 /DWIN32" but /c65001
# is an llvm-rc flag that clang-cl misinterprets as a file path during
# the preprocessing step. Since we build FreeType as a static library,
# the RC version info is unnecessary. Remove it to avoid the error.
vcpkg_replace_string("${SOURCE_PATH}/CMakeLists.txt"
    "if(WIN32)\n  list(APPEND BASE_SRCS src/base/ftver.rc)\nendif()"
    "# ftver.rc removed for Clang-CL compatibility"
)
